    ...
    <!-- <div class="col-md-6 col-sm-12">
        <div class="content-panel" style="padding: 10px ;">
            <div id="chartdivkendala" style="width: 100%; height: 300px;"></div>
        </div>
    </div> -->
    ...
    <div class="content-panel" style="padding: 25px ;">
        ...
        <table class="table table-hover laporan" style="border-color: white">
            ...
            foreach ($tim as $D) {
              ...
              ?>
                        <a href="#">
                          <tr data-href="<?php echo base_url() ; ?>Data_tele/data_psb_detail/<?php echo $D['no_crew'] ; ?>">
                                    <td><?php echo $no++ ; ?></td>
                                    <td><?php echo $D['datel'] ; ?></td>
                                    <td><?php echo $D['kode_teknisi'] ; ?></td>
                                    <td style="text-align: center">3</td>
                                    <td style="text-align: center ;"><?php echo $this->M_Dashboard->get_total($D['kode_teknisi']) ; ?></td>
                                    <td><?php echo $this->M_Dashboard->get_total($D['kode_teknisi'])-3 ; ?></td>
                                    <td><?php echo number_format((33.3333333333*$this->M_Dashboard->get_total($D['kode_teknisi'])), 0, '.', '') ; ?>%</td>
                                </tr>
                            </a>
            <?php
            }
...
<!-- /col-md-12 -->
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var kendala = <?php echo json_encode($get_mitra_kendala); ?> ;
            ...
            AmCharts.makeChart("chartdivkendala",
      				{
                "export": {
                    "enabled": true
                },
      					...
      					"titles": [
      						{
      							"id": "Title-1",
      							"size": 15,
      							"text": "Grafik Kendala Migrasi"
      						}
      					],
      					"dataProvider": kendala
      				}
      			);
        } );
 // end am4core.
