            ...
            foreach ($get_data_psb as $D) {
                echo '
                                <tr>
                                    ...
                                    ' ;
                                    // ;
                                    // $status_sc = str_replace("SC","",''.$D->sc.'');
                                    // $statussc = getsc($status_sc) ;
                                    //
                                    // if($statussc == 'Completed (PS)')
                                    // {
                                    // echo'<button type="button" class="btn btn-success" >'.$statussc.' </button>
                                    // ' ;}
                                    // else {
                                    //   echo'<button type="button" class="btn btn-danger" >'.$statussc.' </button>
                                    //   ' ;}
                                    //
                                    echo '
                                    <td>'. $D->odp .'</td>
